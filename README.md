...
![Latest Version](https://img.shields.io/packagist/v/yireo/magento2-extensionchecker)
<!-- badges.specs.end -->
...
<!-- badges.test.start -->
![Static Tests](https://img.shields.io/github/actions/workflow/status/yireo/Yireo_ExtensionChecker/static-tests.yml?label=static-tests)
![Unit Tests](https://img.shields.io/github/actions/workflow/status/yireo/Yireo_ExtensionChecker/unit-tests.yml?label=unit-tests)
![Integration Tests](https://img.shields.io/github/actions/workflow/status/yireo/Yireo_ExtensionChecker/integration-tests.yml?label=integration-tests)
![Playwright](https://img.shields.io/github/actions/workflow/status/yireo/Yireo_ExtensionChecker/playwright.yml?label=playwright)
![DI Compilation](https://img.shields.io/github/actions/workflow/status/yireo/Yireo_ExtensionChecker/compile.yml?label=compile)
<!-- badges.test.end -->
