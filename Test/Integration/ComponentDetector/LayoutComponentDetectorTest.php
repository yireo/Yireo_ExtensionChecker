...
use Yireo\ExtensionChecker\ComponentDetector\LayoutComponentDetector;
...
class LayoutComponentDetectorTest extends TestCase
{
    use AssertContainsByComponentName;

    public function testGetComponentsByModuleName()
    {
        $componentDetector = ObjectManager::getInstance()->get(LayoutComponentDetector::class);
